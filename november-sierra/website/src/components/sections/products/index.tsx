  ...
  return (
    <section className="px-6 py-24 md:px-12" id="products">
      <div className="section-reveal mx-auto max-w-4xl" ref={ref}>
        <h2 className="text-ns-text-heading mb-12 text-center font-serif text-3xl md:text-4xl">{"Products"}</h2>
        ...
        >
          ...
          <div className="p-6 md:p-8">
            <div className="mb-2 flex items-center gap-2">
              <h3 className="text-ns-text-heading font-serif text-2xl font-bold">{"Anchr"}</h3>
              <ExternalLink
            ...
            <p className="text-ns-text text-lg">
              {"Your harbor for every connection. One page for all your profiles, links, and payment handles."}
            </p>
          </div>
        </a>
      </div>
